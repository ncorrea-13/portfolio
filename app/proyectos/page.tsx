  ...
  return (
    <>
      <Reveal>
        ...
        <p className="mb-6">
          Proyectos en los que he participado, la mayoría open source. Código y
          detalles en cada repositorio.
        </p>
      </Reveal>
      ...
      <Reveal>
        ...
        <p>
          Además de estos proyectos poseo varios trabajos académicos y
          experimentos menores. El listado completo, siempre actualizado, está
